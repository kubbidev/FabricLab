...
public final class FabricLabMod implements ClientModInitializer {

    public static final String MOD_ID = "fabriclab";
    ...
    public static final ModContainer MOD_CONTAINER = FabricLoader.getInstance().getModContainer(MOD_ID)
        .orElseThrow(() -> new RuntimeException("Could not get the FabricLab mod container."));
    ...
    private void onClientStarted(MinecraftClient client) {
        ...
        // register the fabriclab provider
        FabricLabModProvider.register(this);
    ...
    private void onClientStopping(MinecraftClient client) {
        ...
        // unregister provider
        FabricLabModProvider.unregister();
