...
publishing {
    publications {
        create<MavenPublication>("maven") {
            artifactId = "fabriclab"

            from(components["java"])
            pom {
                name = "FabricLab"
                description = "A Minecraft mod that gather useful features for debugging."
                url = "https://github.com/kubbidev/FabricLab"
                ...
                issueManagement {
                    system = "GitHub"
                    url = "https://github.com/kubbidev/FabricLab/issues"
                }
            }
        }
    }
